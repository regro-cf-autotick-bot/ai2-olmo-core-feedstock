...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ai2-olmo-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ai2-olmo-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ai2-olmo-core
# for installing globally
pixi global install ai2-olmo-core
```
...
It is possible to list all of the versions of `ai2-olmo-core` available on your platform:
...
```
pixi search ai2-olmo-core --channel conda-forge
```
